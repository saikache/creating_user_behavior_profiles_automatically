...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { email: @history.email, employeeid: @history.employeeid, user_name: @history.user_name }
    end
  ...
  test "should update history" do
    put :update, id: @history, history: { email: @history.email, employeeid: @history.employeeid, user_name: @history.user_name }
    assert_redirected_to history_path(assigns(:history))
  end
